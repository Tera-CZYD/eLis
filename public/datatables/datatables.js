 ...
 *   https://datatables.net/download/#dt/dt-1.13.7/b-2.4.2/r-2.5.0/sb-1.6.0
 *
 * Included libraries:
 *   DataTables 1.13.7, Buttons 2.4.2, Responsive 2.5.0, SearchBuilder 1.6.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.7/b-2.4.2/r-2.5.0/sb-1.6.0",
